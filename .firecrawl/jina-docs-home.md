# Jina AI Meta-Prompt: An Implementation Guide for LLMs (v13)

**⚠️ Note:** This content is specifically designed for LLMs and not intended for human reading.

👉 For human-readable content, please visit [Jina AI](https://jina.ai/)
...
🌐 You see this HTML because you are in a browser. If you access it via curl/code/program, you get a text/plain response as below. [Check out our Github for more info.](https://github.com/jina-ai/meta-prompt/)
...
For direct content access: `curl docs.jina.ai/v13`